        ...
        <div className="max-w-2xl mx-auto">
          <GlassCard className="p-6 sm:p-8 md:p-12 text-center">
            ...
            >
              ...
              <p className="text-lg text-white/80 leading-relaxed">
                You will receive your evaluated automation roadmap <span className="text-primary font-semibold">within 7 days</span>.
              </p>
              <div className="bg-secondary/5 border border-secondary/20 rounded-lg p-4 text-left">
                <p className="text-sm text-white/70 mb-2 font-semibold">What to expect in your roadmap:</p>
                <ul className="text-xs md:text-sm text-white/60 space-y-1.5">
                  <li>• Top 3–7 automation opportunities tailored to your stack</li>
                  <li>• Estimated monthly impact in your currency (₹/€/£)</li>
                  <li>• Approximate implementation ranges for each automation</li>
